...
template <class classInst,class HistogramCreater> bool Looper_data<classInst,HistogramCreater>::ZZM12TLM(TChain *tr,classInst& read,string ProcessName,int iEvent){

return true;
}

template <class classInst,class HistogramCreater> bool Looper_data<classInst,HistogramCreater>::ZZM22TLM(TChain *tr,classInst& read,string ProcessName,int iEvent){

return true;
}

template <class classInst,class HistogramCreater> bool Looper_data<classInst,HistogramCreater>::ZZM32TLM(TChain *tr,classInst& read,string ProcessName,int iEvent){

return true;
}

template <class classInst,class HistogramCreater> bool Looper_data<classInst,HistogramCreater>::ZZM11TLM(TChain *tr,classInst& read,string ProcessName,int iEvent){

return true;
}

template <class classInst,class HistogramCreater> bool Looper_data<classInst,HistogramCreater>::ZZM21TLM(TChain *tr,classInst& read,string ProcessName,int iEvent){

return true;
}

template <class classInst,class HistogramCreater> bool Looper_data<classInst,HistogramCreater>::ZZM31TLM(TChain *tr,classInst& read,string ProcessName,int iEvent){

return true;
}

template <class classInst,class HistogramCreater> bool Looper_data<classInst,HistogramCreater>::ZZM12TTM(TChain *tr,classInst& read,string ProcessName,int iEvent){

return true;
}

template <class classInst,class HistogramCreater> bool Looper_data<classInst,HistogramCreater>::ZZM22TTM(TChain *tr,classInst& read,string ProcessName,int iEvent){

return true;
}

template <class classInst,class HistogramCreater> bool Looper_data<classInst,HistogramCreater>::ZZM32TTM(TChain *tr,classInst& read,string ProcessName,int iEvent){

return true;
}

template <class classInst,class HistogramCreater> bool Looper_data<classInst,HistogramCreater>::ZZM11TTM(TChain *tr,classInst& read,string ProcessName,int iEvent){

return true;
}

template <class classInst,class HistogramCreater> bool Looper_data<classInst,HistogramCreater>::ZZM21TTM(TChain *tr,classInst& read,string ProcessName,int iEvent){

return true;
}

template <class classInst,class HistogramCreater> bool Looper_data<classInst,HistogramCreater>::ZZM31TTM(TChain *tr,classInst& read,string ProcessName,int iEvent){
