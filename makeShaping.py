...
for icat in range(0,len(data.list_Categories)):
  for ivar in range(0,len(data.list_oneVariables)):
   # print 'shape.plotS1B4D0("%s(GeV)",tpav_txt,hl.h_[%s][0][%s],"ZH_mG1300",hl.h_[%s][2][%s],"QCD",hl.h_[%s][3][%s],"TTJets",hl.h_[%s][4][%s],"WJets",hl.h_[%s][5][%s],"ZJets");\n'%(data.list_oneVariables[ivar],ivar,icat,ivar,icat,ivar,icat,ivar,icat,ivar,icat)
   # print 'shape.plotS1B4D0("%s(GeV)",tpav_txt,hl.h_[%s][1][%s],"ZH_mG1700",hl.h_[%s][2][%s],"QCD",hl.h_[%s][3][%s],"TTJets",hl.h_[%s][4][%s],"WJets",hl.h_[%s][5][%s],"ZJets");\n'%(data.list_oneVariables[ivar],ivar,icat,ivar,icat,ivar,icat,ivar,icat,ivar,icat)
    print 'shape.plotS0B4D0("%s(GeV)",tpav_txt,hl.h_[%s][2][%s],"QCD",hl.h_[%s][3][%s],"TTJets",hl.h_[%s][4][%s],"WJets",hl.h_[%s][5][%s],"ZJets");\n'%(data.list_oneVariables[ivar],ivar,icat,ivar,icat,ivar,icat,ivar,icat)
    print 'shape.plotS2B4D0("%s(GeV)",tpav_txt,hl.h_[%s][0][%s],"ZH_mG1300",hl.h_[%s][1][%s],"ZH_mG1700",hl.h_[%s][2][%s],"QCD",hl.h_[%s][3][%s],"TTJets",hl.h_[%s][4][%s],"WJets",hl.h_[%s][5][%s],"ZJets");\n'%(data.list_oneVariables[ivar],ivar,icat,ivar,icat,ivar,icat,ivar,icat,ivar,icat,ivar,icat)
print '\n'
